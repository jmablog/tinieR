...
output:
  rmarkdown::html_vignette:
    toc: true
vignette: >
  %\VignetteIndexEntry{full-walkthrough}
...
This vignette is a full walkthrough of all the features of **tinieR**.
...
(See the [defaults](https://jmablog.github.io/tinieR/articles/tinieR.html#changing-default-options-for-tinify-1) section later to set defaults that allow you to skip including all these arguments every time you use `tinify()`.)
...
#> Tinify 'suffix' set to: "_resized"
#> Tinify 'quiet' set to: TRUE
#> Tinify 'return_path' set to: "proj"
#> Tinify 'resize' method set to: "scale"
#> Tinify 'resize' width set to: 100
